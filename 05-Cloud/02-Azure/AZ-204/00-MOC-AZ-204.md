...
> 📚 Cert **AZ-204 (Azure Developer Associate)** — góc nhìn **lập trình viên** (SDK, code, binding, deploy) bổ sung cho AZ-900 (khái niệm) và AI-102 (AI). Nhiều dịch vụ trùng tên với AZ-900 nhưng AZ-204 đào sâu *cách viết code dùng dịch vụ đó*.
> Nguồn: `_source/Microsoft/Az-204.docx` (12 lesson / 5 module) + Microsoft Learn.
>
> **Trạng thái:** 🚧 Khung dựng xong (2026-06-28) — viết nội dung tuần tự theo cụm. Quy ước: 🚧 chưa viết · 🟡 đang viết · ✅ xong.
...
## Liên quan
- [[../00-MOC-Azure]] — MOC Azure tổng (AZ-900 + AI-Azure + AI-102)
- [[../AI-102/00-MOC-AI-102]] — cert AI-102 (AI-trên-Azure)
