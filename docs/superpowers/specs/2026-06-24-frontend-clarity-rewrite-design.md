...
- [~] **Cụm 3 — React/Next.js** (06-React, 18 note) — ĐANG LÀM. Xong (10): 01-Overview, 02-Component&Props, 03-useState, 04-JSX/List, 06-Form, 08-useEffect, 11-Context, 14-Router, 15-Fragments, + note MỚI 19-Performance(memo/useMemo/useCallback). Còn (9): 05-Event-Handling, 07-Lifecycle, 09-CSS-in-JS, 10-Styled-Component, 12-Context-useState, 13-Context-useReducer, 16-NextJS-App-Router, 17-Server-vs-Client, 18-Server-Actions.
